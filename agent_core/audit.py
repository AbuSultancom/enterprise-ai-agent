...
class AuditLogger:
    ...
    @staticmethod
    def log_event(event_type: str, user_id: str, details: dict[str, Any], status: str = "SUCCESS") -> None:
        record = {
    ...
    @classmethod
    def log_tool_call(cls, tool_name: str, args: dict[str, Any], user_id: str, status: str = "SUCCESS", result_snippet: str = "") -> None:
        cls.log_event(
